...
\author{Jonas U. Benn}
\orcid{0000-0002-6625-9707}
\email{mail@benn.in}

%\renewcommand{\shortauthors}{Benn}
...
\vspace*{\fill}
\begin{center}
Maybe we could place the expression problem figure here :)
Or we put the text on the left and the figure on the right.
\end{center}
\vspace*{\fill}
\clearpage
