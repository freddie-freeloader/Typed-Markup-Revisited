\begin{abstract}
  ...
  (TF) encoding can help to create truly extensible representations for markup
  ...
  \begin{itemize}
  \item truly extensible—i.e. in the dimension of \emph{variants} and the
    dimension of \emph{observers}
  \item provides strong guarantees in regards to the well-formedness of the
    created abstract syntax trees
  \end{itemize}
\end{abstract}
